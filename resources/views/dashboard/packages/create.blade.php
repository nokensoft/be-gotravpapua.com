                    ...
                    <div class="row">
                        <div class="col-lg-8">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" id="title" name="title" class="form-control rounded-0" placeholder="write package title here">
                            ...
                            <div class="mb-3">
                                ...
                                <textarea id="my-editor" name="body" rows="8" class="ckeditor form-control rounded-0" placeholder="Type..."></textarea>
